            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-sm-12 col-xl">
                    <div class="bg-light rounded h-100 p-4">
                        <h1 class="display-4">Ajout Formations</h1>
                    </div>
                </div>
                <!-- Title Page End -->
                <!-- Form Page Start -->
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="index.php?page=formation&action=update&id=<?=$formation['id']?>">Update</a>
                                            <a class="btn btn-sm btn-secondary" href="index.php?page=formation&action=delete&id=<?=$formation['id']?>">Delete</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
